...
<Warning>
  **Most of this documentation has been unpublished.** It was written by an agent reasoning
  ...
  errors on 10 of 17 pages, including a page that described a recording indicator as visible
  to everyone in a call when it is only visible to the person recording.
...
It runs on your machine, on your own agent subscription. There is no Vibeconferencing account.
