...
|---|---|
| a bare tag (`es`, `en`) | **the first regional variant Meet happens to list** — not a fixed choice. `es` has resolved to `es-ES` in testing; don't rely on any particular region from a bare tag (`google-meet-provider.js:2902-2912`) |
